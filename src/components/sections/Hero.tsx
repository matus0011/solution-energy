...
export default function Hero() {
  ...
  return (
    <section className="mx-auto w-full max-w-[1380px] 2xl:max-w-screen-2xl">
      <div className="relative flex min-h-[360px] items-center overflow-hidden sm:min-h-[520px] lg:min-h-[600px]">
        ...
        <div className="relative w-full px-6 py-16 sm:px-10 sm:py-20 lg:px-14">
          <div className="mx-auto flex max-w-[1380px] 2xl:max-w-screen-2xl flex-col gap-7">
      ...
      <div className="hidden bg-[#26282C] px-6 py-10 sm:px-10 sm:py-12 md:block lg:px-14">
        <div className="mx-auto grid max-w-[1380px] 2xl:max-w-screen-2xl grid-cols-1 gap-8 sm:gap-0 md:grid-cols-3">
          {homeHighlights.map((item, index) => {
